...
public class ReviewFormActivityTest {
    ...
    public void acceptFormButtonTest() {
        ...
        // test toast.
        assertEquals(
                reviewFormActivity.getString(R.string.form_approved), ShadowToast.getTextOfLatestToast());
    ...
    /**
    * {@link Test} the reject {@link android.widget.Toast}. {@link Test} if the {@link
    * android.app.Activity} is finished. {@link Test} if the {@link android.widget.EditText} is
    * correct.
    */
    @Test
    public void rejectFormButtonTest() {
        ...
        // test toast.
        assertEquals(
                reviewFormActivity.getString(R.string.form_rejected), ShadowToast.getTextOfLatestToast());
