...
/** @author huangyz0918 (huangyz0918@gmail.com) For putting utils for permission checks. */
public class PermissionUtils {
    ...
    public static boolean isGPSEnabled(Context targetActivity) {
        LocationManager locationManager =
                (LocationManager) targetActivity.getSystemService(LOCATION_SERVICE);
    ...
    public static void showLocationAlertDialog(Activity targetActivity) {
        ...
        builder.setPositiveButton(
                targetActivity.getString(R.string.settings),
    ...
    public static void showAppInfo(
            Activity targetActivity, String packageName, String msg, String deniedMsg) {
        AlertDialog.Builder builder = new AlertDialog.Builder(targetActivity);
        builder.setMessage(msg);

        builder.setPositiveButton(
                targetActivity.getString(R.string.permission_open_info_button),
                (DialogInterface dialog, int which) -> {
