...
public class DialogUtils {
    ...
    /**
    * Create a simple {@link AlertDialog} for showing messages, after that, we finish the {@link
    * Activity}.
    */
    public static AlertDialog createSimpleDialog(
        ...
        alertDialog.setButton(
                ...
                (dialog, i) -> ((Activity) context).finish());
        return alertDialog;
    }

    /** Create an {@link AlertDialog} for switching receive method. */
    public static AlertDialog createMethodSwitchDialog(
            @NonNull Activity targetActivity, DialogInterface.OnClickListener listener) {
        AlertDialog alertDialog = new AlertDialog.Builder(targetActivity).create();
        alertDialog.setCancelable(false);
        alertDialog.setButton(
                DialogInterface.BUTTON_POSITIVE,
                targetActivity.getString(R.string.cancel),
                (dialog, i) -> {
                    dialog.dismiss();
                });
        ...
        alertDialog.setButton(
                ...
                targetActivity.getString(R.string.switch_method),
                listener);

        // the icons set in the dialog are for destinations.
        if (targetActivity instanceof BtReceiverActivity
                || targetActivity instanceof BtSenderActivity) {
        ...
        } else if (targetActivity instanceof HpReceiverActivity
                || targetActivity instanceof HpSenderActivity) {
    ...
    public static void switchToDefaultSendingMethod(
        ...
        String defaultMethod =
                prefs.getString(
                        ...
                        context.getString(R.string.default_hotspot_ssid));
