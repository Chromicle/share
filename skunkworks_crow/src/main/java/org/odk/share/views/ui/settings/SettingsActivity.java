...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceCategory preferenceCategory =
                (PreferenceCategory) findPreference(PreferenceKeys.KEY_ODK_SETTINGS);
    ...
    private void addPreferences() {
        defaultMethodPreference =
                (ListPreference) findPreference(PreferenceKeys.KEY_DEFAULT_TRANSFER_METHOD);
        hotspotNamePreference = (EditTextPreference) findPreference(PreferenceKeys.KEY_HOTSPOT_NAME);
        bluetoothNamePreference =
                (EditTextPreference) findPreference(PreferenceKeys.KEY_BLUETOOTH_NAME);
        hotspotPasswordPreference = findPreference(PreferenceKeys.KEY_HOTSPOT_PASSWORD);
        passwordRequirePreference =
                (CheckBoxPreference) findPreference(PreferenceKeys.KEY_HOTSPOT_PWD_REQUIRE);
        btSecureModePreference =
                (CheckBoxPreference) findPreference(PreferenceKeys.KEY_BLUETOOTH_SECURE_MODE);
        odkDestinationDirPreferenceEditText =
                (EditTextPreference) findPreference(PreferenceKeys.KEY_ODK_DESTINATION_DIR_EDIT_TEXT);
        odkDestinationDirPreferenceDirectoryPicker =
                (Preference) findPreference(PreferenceKeys.KEY_ODK_DESTINATION_DIR_DIRECTORY_PICKER);

        prefs = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        defaultMethodPreference.setSummary(
                prefs.getString(
                        PreferenceKeys.KEY_DEFAULT_TRANSFER_METHOD, getString(R.string.default_hotspot_ssid)));
        hotspotNamePreference.setSummary(
                prefs.getString(PreferenceKeys.KEY_HOTSPOT_NAME, getString(R.string.default_hotspot_ssid)));
        ...
        bluetoothNamePreference.setSummary(
                prefs.getString(PreferenceKeys.KEY_BLUETOOTH_NAME, defaultBluetoothName));
        boolean isPasswordSet = prefs.getBoolean(PreferenceKeys.KEY_HOTSPOT_PWD_REQUIRE, false);

        odkDestinationDirPreferenceDirectoryPicker.setSummary(
                prefs.getString(
                        PreferenceKeys.KEY_ODK_DESTINATION_DIR_DIRECTORY_PICKER,
                        getString(R.string.default_odk_destination_dir)));
        odkDestinationDirPreferenceEditText.setSummary(
                prefs.getString(
        ...
        odkDestinationDirPreferenceDirectoryPicker.setOnPreferenceClickListener(
        ...
        return (preference, newValue) -> {
            switch (preference.getKey()) {
                case PreferenceKeys.KEY_HOTSPOT_NAME:
                    ...
                    if (name.length() == 0) {
                        Toast.makeText(
                                        getBaseContext(), getString(R.string.hotspot_name_error), Toast.LENGTH_LONG)
                                .show();
                        return false;
                    } else {
                ...
                case PreferenceKeys.KEY_BLUETOOTH_NAME:
                    ...
                    if (bluetoothName.length() == 0) {
                        Toast.makeText(
                                        getBaseContext(), getString(R.string.bluetooth_name_error), Toast.LENGTH_LONG)
                                .show();
                        return false;
                    } else {
                ...
                case PreferenceKeys.KEY_HOTSPOT_PASSWORD:
                    ...
                    if (password.length() < 8) {
                        Toast.makeText(
                                        getBaseContext(), getString(R.string.hotspot_password_error), Toast.LENGTH_LONG)
                                .show();
                        return false;
                    }
                    break;
                ...
                case PreferenceKeys.KEY_ODK_DESTINATION_DIR_EDIT_TEXT:
                    ...
                    if (dir.length() == 0) {
                        Toast.makeText(
                                        ...
                                        getString(R.string.odk_destination_dir_error),
                                        Toast.LENGTH_LONG)
                                .show();
                        return false;
                    } else {
                        ...
                        prefs
                                .edit()
                                .putString(PreferenceKeys.KEY_ODK_DESTINATION_DIR_DIRECTORY_PICKER, null)
                                .apply();
                    }
                    break;
    ...
    private void showPasswordDialog() {
        ...
        tlPassword
                ...
                .setText(
                        prefs.getString(
                                PreferenceKeys.KEY_HOTSPOT_PASSWORD, getString(R.string.default_hotspot_password)));
    ...
    public void chooseDirectory() {
        ...
        startActivityForResult(
                Intent.createChooser(i, getString(R.string.choose_directory)), DIRECTORY_REQUEST_CODE);
    }
        ...
        switch (requestCode) {
            case DIRECTORY_REQUEST_CODE:
                try {
                    ...
                    prefs
                            .edit()
                            .putString(PreferenceKeys.KEY_ODK_DESTINATION_DIR_DIRECTORY_PICKER, filePath)
                            .apply();
