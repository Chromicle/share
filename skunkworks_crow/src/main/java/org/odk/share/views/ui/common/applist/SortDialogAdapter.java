...
public class SortDialogAdapter extends RecyclerView.Adapter<SortDialogAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemLayoutView =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.sort_item_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.imgViewIcon.setImageResource(
                ApplicationConstants.getSortLabelToIconMap(context).get(sortList[position]));
        viewHolder.imgViewIcon.setImageDrawable(
                DrawableCompat.wrap(viewHolder.imgViewIcon.getDrawable()).mutate());

        int color =
                position == selectedSortingOrder
                        ? ContextCompat.getColor(context, R.color.colorAccent)
                        : ContextCompat.getColor(context, android.R.color.black);
        viewHolder.txtViewTitle.setTextColor(color);
        DrawableCompat.setTintList(
                viewHolder.imgViewIcon.getDrawable(),
                position == selectedSortingOrder ? ColorStateList.valueOf(color) : null);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void updateItemColor(int selectedSortingOrder) {
            ViewHolder previousHolder =
                    (ViewHolder) recyclerView.findViewHolderForAdapterPosition(selectedSortingOrder);
            previousHolder.txtViewTitle.setTextColor(
                    ContextCompat.getColor(context, android.R.color.black));
            ...
            DrawableCompat.setTint(
                    imgViewIcon.getDrawable(), ContextCompat.getColor(context, R.color.colorAccent));
        }
    }
